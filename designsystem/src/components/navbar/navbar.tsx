...
export const Navbar = ({
  ...
  return (
    <>
      <nav className="relative w-full flex flex-wrap items-center justify-between p-4 bg-gray-800 text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light">
        <div className="container-fluid flex flex-wrap items-center justify-between  relative">
        ...
        <a href="" target="_blank" className="flex items-center relative">
