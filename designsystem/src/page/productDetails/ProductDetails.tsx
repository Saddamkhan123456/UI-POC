...
import { addCartProducts, getProduct } from '../../redux/actions/ActionsCreators';
            ...
            <div className='flex flex-col md:flex-row '>
              ...
              <div className='md:flex-1  mt-4 px-6'>
                <div className='max-w-lg'>
                  <h1 className='mb-2 text-theme-neutral capitalize text-2xl '>{product?.product?.title}</h1>
                  <p className='mb-4 text-theme-neutral25 capitalize'>{product?.product?.brand?.title}</p>
                  <div className='product-descriptiom'>
                    <p className='mb-4 text-theme-neutral25 font-light text-lg'>{product?.product?.description}</p>
                  </div>
