      ...
      <Card className='flex h-full items-center justify-center w-full'>
        <CardBody className='w-full flex p-0'>
          <div className='w-full flex flex-col'>
            <form className='w-full mx-auto flex flex-col justify-center' onSubmit={handleSubmit(handleEdit)}>
              <div className='flex flex-col space-y-4 sm:space-y-5'>
                <div className='flex flex-col sm:flex-row sm:space-s-3 space-y-4 sm:space-y-0'>
                  <div className='w-full'>
                    <label className='block text-gray-600  text-sm leading-none mb-3 cursor-pointer'>Name *</label>
                    <input
                      {...register('name', {
                        required: true,
                        minLength: 5,
                ...
                <div className='flex flex-col sm:flex-row sm:space-s-3 space-y-4 sm:space-y-0'>
                  ...
                  <div className='w-full sm:w-1/2'>
                    <label className='block text-gray-600 text-sm leading-none mb-3 cursor-pointer'>Email *</label>
                    <input
                      {...register('email', {
                        required: true,
                ...
                <div className='flex flex-col sm:flex-row sm:space-s-3 space-y-4 sm:space-y-0'>
                  <div className='w-full'>
                    <label className='block text-gray-600  text-sm leading-none mb-3 cursor-pointer'>Address *</label>
                    <textarea
                      {...register('address', {
                        required: true,
                      })}
